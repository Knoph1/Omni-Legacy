        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none space-y-8">
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                All intellectual property rights in custom software and solutions developed by O.L Ltd. shall be
                transferred to the client upon full payment, unless otherwise specified in the service agreement. O.L
                Ltd. retains rights to general methodologies and know-how.
              </p>
            </section>
