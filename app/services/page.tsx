...
export const metadata: Metadata = {
  title: "IT Services Kenya | Custom Software Development | Cybersecurity | Cloud Solutions - Omni-Legacy Limited",
  description:
  ...
  openGraph: {
    title: "IT Services Kenya | Custom Software Development | Cybersecurity - Omni-Legacy Limited",
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Omni-Legacy Limited - IT Services Kenya",
      },
    ],
    locale: "en_KE",
    type: "website",
  ...
  twitter: {
    ...
    title: "IT Services Kenya | Custom Software Development - Omni-Legacy Limited",
    description:
