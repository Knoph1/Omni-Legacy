...
export const metadata: Metadata = {
  title: "IT Services Kenya | Custom Software Development | Cybersecurity | Cloud Solutions - Omni-Legacy Ltd.",
  description:
  ...
  openGraph: {
    title: "IT Services Kenya | Custom Software Development | Cybersecurity - Omni-Legacy Ltd.",
    description:
  ...
  twitter: {
    ...
    title: "IT Services Kenya | Custom Software Development - Omni-Legacy Ltd.",
    description:
