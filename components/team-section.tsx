...
const executives = [
  {
    ...
    skills: [
      "Business Development", "Strategic Leadership", "Governance", "Tendering",
      "Investor Relations", "Strategic Vision", "Financial Acumen",
      "Market Analysis", "Negotiation", "Talent Management"
    ],
  },
  {
    name: "Knoph O. Ayieko",
    ...
    image: "/cto - knoph.png",
    skills: [
      "Full-Stack Development", "Cybersecurity", "Digital Systems", "Innovation Strategy",
      "Compliance", "Systems Architecture", "Cloud & Infrastructure Management",
      "Data & AI Integration", "DevOps & Automation"
    ],
  },
  {
    name: "Maryann H. Agau",
    ...
    skills: [
      "Operations Management", "Partnerships", "Project Execution", "Tender Documentation",
      "Client Relations", "Product Management", "Agile Methodologies",
      "Risk Management", "Business Process Optimization"
    ],
  },
]
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto items-stretch">
          {executives.map((exec, index) => (
            ...
            >
              {/* Fixed image container ensures alignment */}
              <div className="w-full h-64 flex items-end justify-center bg-white">
                <img
              ...
              <CardContent className="flex flex-col flex-1 p-6 justify-between">
                <div className="flex flex-col flex-1">
                  ...
                  {/* Vision */}
                  <div className="bg-background p-3 rounded-lg flex items-center justify-center mt-3 flex-1">
