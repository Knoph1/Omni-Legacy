...
const executives = [
  {
    ...
    skills: ["Business Development", "Strategic Leadership", "Governance", "Tendering", "Investor Relations", "Strategic Vision", "Financial Acumen", "Market Analysis", "Negotiation", "Talent Management"],
  },
  {
    name: "Knoph O. Ayieko",
  ...
  },
  {
    ...
    skills: ["Operations Management", "Partnerships", "Project Execution", "Tender Documentation", "Client Relations", "Product Management", "Agile Methodologies", "Risk Management", "Business Process Optimization"],
  },
]
